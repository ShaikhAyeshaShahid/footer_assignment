...
const Footer = () => {
  return (
 <div>
  <footer className="text-gray-600 body-font  h-25 ">
  <div className="container px-5 py-12 mx-auto">
    <div className="flex flex-wrap md:text-left text-center order-first h-20">
  ...
  <div className="bg-gray-100  gap-2  h-25">
    <div className="container px-5 h-20 py-6 mx-auto flex items-center sm:flex-row flex-col">
